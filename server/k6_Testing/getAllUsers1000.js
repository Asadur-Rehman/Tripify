...
export let options = {
    stages: [
        { duration: '60s', target: 1000 }, // Ramp-up to 50 virtual users over 30 seconds
        { duration: '30s', target: 1000 }, // Stay at 50 virtual users for 60 seconds
        { duration: '20s', target: 0 }, // Ramp-down to 0 virtual users over 30 seconds
    ],
    thresholds: {

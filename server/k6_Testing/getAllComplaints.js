...
export let options = {
    stages: [
        ...
        { duration: '20s', target: 50 }, // Stay at 50 virtual users for 20 seconds
...
const GET_COMPLAINTS_ENDPOINT = '/getAllComplaints'; // Endpoint for getting all complaints

export default function () {
    let res = http.get(`${BASE_URL}${GET_COMPLAINTS_ENDPOINT}`);
